...
public class StepsListAdapter extends RecyclerView.Adapter<StepsListAdapter.StepViewHolder>  {
    ...
    public class StepViewHolder extends RecyclerView.ViewHolder {
        ...
        // Main layout
        @BindView(R.id.step_card_main_layout)
        LinearLayout mStepCardMainLayout;

        // Views
        @BindView(R.id.step_card_title)
        TextView mStepCardTitle;
        @BindView(R.id.step_card_description)
        TextView mStepCardDescription;
        @BindView(R.id.step_card_video)
        ImageView mStepCardVideo;
        @BindView(R.id.step_card_arrow)
        ImageView mStepCardArrow;
